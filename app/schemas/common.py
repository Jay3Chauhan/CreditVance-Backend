...
class PaginationMeta(BaseModel):
    ...
    applied_filters: Optional[dict[str, Any]] = Field(None, description="Active query filters applied to this result set")
...
class ApiResponse(BaseModel, Generic[DataT]):
    ...
    detail: Optional[str] = Field(None, description="Optional informational or error detail message")
